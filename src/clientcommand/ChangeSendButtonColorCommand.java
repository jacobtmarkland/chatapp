...
public class ChangeSendButtonColorCommand extends AbstractCommand{

	protected JButton jButton;
	protected ColorPalette colorPalette;
	
	public ChangeSendButtonColorCommand(JButton jButton) {
		super("Change send button color", "changesendbutton");
